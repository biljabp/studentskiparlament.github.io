...
if (isset($_SESSION['user'])){
    $button="<button type=\"button\" 
              data-dismiss=\"modal\"  class=\"btn btn-success btn-guest btn-md\" id='userBtn'>
              Naplati
              </button>";
} else {
    $button="<button type=\"button\" data-toggle=\"modal\" 
                                        data-target=\"#checkoutModal\" 
                                        data-dismiss=\"modal\"  class=\"btn btn-success btn-programmable btn-md\" id='guestBtn'>
                                            Naplati
                                        </button>";
}
...
while ($row = mysqli_fetch_array($cart_items,MYSQLI_ASSOC))
{
    ...
    $products.="                    <div class='row'>
                                    ...
                                    <div class=\"col-lg-6\">
                                        ...
                                        <div class=\"col-lg-4\">
                                            <input type=\"text\" class=\"form-control input-sm product_amount \" id='valuedInput".$row['idproizvod']."' data-id='".$row['idproizvod']."' data-price='".$row['cena']."' value=\"".$counted_arrays[$row['idproizvod']]."\" disabled>
                ...
                <div class=\"row\">
                    <div class=\"col-lg-12\">
                        <div class=\"panel panel-info\">
                            ...
                            <div class=\"panel-body\">
                                "."<h1>Korpa je prazna, dodajte proizvode.</h1>"."
